                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6 pt-1">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('adminroles')" active="request()->routeIs('adminroles')">
                                    {{ __('Admin Roles') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('adminpermissions')" active="request()->routeIs('useradminpermissionsroles')">
